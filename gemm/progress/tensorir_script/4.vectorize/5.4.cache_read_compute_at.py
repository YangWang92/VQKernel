                            ...
                            for k_0 in range(1024):
                                for ax0, ax1 in T.grid(16, 128):
                                    with T.block("AT_shared"):
                                        ...
                                        v1 = T.axis.spatial(16384, i_0 * 128 + ax1)
                                        T.reads(AT[v0, v1])
                                ...
                                for k_1 in range(16):
                                    for ax0 in range(4):
                                        with T.block("AT_shared_local"):
                                            ...
                                            v1 = T.axis.spatial(16384, i_0 * 128 + i_1_0 * 64 + i_1_1_0 * 4 + ax0)
                                    ...
                                    for ax0 in range(4):
                                        with T.block("B_shared_local"):
                                            v0 = T.axis.spatial(16384, k_0 * 16 + k_1)
                                            v1 = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 64 + j_1_1_0 * 4 + ax0)
                                            T.reads(B_shared[v0, v1])
                                            T.writes(B_shared_local[v0, v1])
                                            B_shared_local[v0, v1] = B_shared[v0, v1]
                                    for j_1_1_1, i_1_1_1 in T.grid(4, 4):
                                        with T.block("B"):
